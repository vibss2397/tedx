...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label" style="color:#222222;">E-Mail</label>  
    <div class="col-md-6 inputGroupContainer">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-md-4 control-label" style="color:#222222;">Phone</label>  
    <div class="col-md-6 inputGroupContainer">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-md-4 control-label" style="color:#222222;">Your Message</label>
    <div class="col-md-6 inputGroupContainer">
    <div class="input-group">
...
function showPage() {
  ...
  document.getElementById("myDiv").style.display = "block";
	...
	<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvONUt0bC0uLAaD3zx2iIa-s02_XCXqtU&callback=initMap">
    </script> 
    <!-- jQuery -->
